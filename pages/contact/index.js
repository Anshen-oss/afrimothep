      ...
      <div class="container mx-auto pt-16">
        <div class="lg:flex">
          <div class="xl:w-2/5 lg:w-2/5 bg-indigo-700 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
            <div class="xl:w-5/6 xl:px-0 px-8 mx-auto">
              ...
              <p class="text-xl text-white pb-8 leading-relaxed font-normal lg:pr-4">
                Vous avez une question sur nous? Êtes-vous intéressé par un
                partenariat avec nous? Vous avez des suggestions ou vous voulez
                simplement dire bonjour ? Contactez-nous. Nous sommes là pour
                vous.
              </p>
              ...
              <div class="flex items-center">
                ...
                <p class="pl-4 text-white text-base">Info@afrimothep.com</p>
              </div>
              <p class="text-lg text-white pt-10 tracking-wide">
                6, rue Dr Arnold Netter
                <br />
                Paris 13eme, France
              </p>
              <div class=" pt-16">
          ...
          <div class="xl:w-3/5 lg:w-3/5 bg-gray-200 dark:bg-gray-600 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
            ...
            >
              <h1 class="text-4xl text-gray-800 dark:text-white font-extrabold mb-6">
                Enter Details
              </h1>
